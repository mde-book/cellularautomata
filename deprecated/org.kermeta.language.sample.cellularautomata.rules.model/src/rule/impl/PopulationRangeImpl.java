 ...
 * <ul>
 *   <li>{@link rule.impl.PopulationRangeImpl#getLowerRange <em>Lower Range</em>}</li>
 *   <li>{@link rule.impl.PopulationRangeImpl#getUpperRange <em>Upper Range</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PopulationRangeImpl extends EObjectImpl implements PopulationRange {
	/**
	...
	protected EClass eStaticClass() {
		return RulePackage.Literals.POPULATION_RANGE;
	}
	...
	public void setLowerRange(int newLowerRange) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RulePackage.POPULATION_RANGE__LOWER_RANGE, oldLowerRange, lowerRange));
	}
	...
	public void setUpperRange(int newUpperRange) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RulePackage.POPULATION_RANGE__UPPER_RANGE, oldUpperRange, upperRange));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RulePackage.POPULATION_RANGE__LOWER_RANGE:
				return getLowerRange();
			case RulePackage.POPULATION_RANGE__UPPER_RANGE:
