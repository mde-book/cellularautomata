 ...
 * <ul>
 *   <li>{@link rule.impl.ConditionalImpl#getIfTrueExpression <em>If True Expression</em>}</li>
 *   <li>{@link rule.impl.ConditionalImpl#getIfFalseExpression <em>If False Expression</em>}</li>
 *   <li>{@link rule.impl.ConditionalImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConditionalImpl extends IntegerExpressionImpl implements Conditional {
	...
	protected EClass eStaticClass() {
		return RulePackage.Literals.CONDITIONAL;
	}
	...
	public NotificationChain basicSetIfTrueExpression(IntegerExpression newIfTrueExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RulePackage.CONDITIONAL__IF_TRUE_EXPRESSION, oldIfTrueExpression, newIfTrueExpression);
	...
	public void setIfTrueExpression(IntegerExpression newIfTrueExpression) {
		if (newIfTrueExpression != ifTrueExpression) {
			...
			if (ifTrueExpression != null)
				msgs = ((InternalEObject)ifTrueExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RulePackage.CONDITIONAL__IF_TRUE_EXPRESSION, null, msgs);
			if (newIfTrueExpression != null)
				msgs = ((InternalEObject)newIfTrueExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RulePackage.CONDITIONAL__IF_TRUE_EXPRESSION, null, msgs);
			msgs = basicSetIfTrueExpression(newIfTrueExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RulePackage.CONDITIONAL__IF_TRUE_EXPRESSION, newIfTrueExpression, newIfTrueExpression));
	}
	...
	public NotificationChain basicSetIfFalseExpression(IntegerExpression newIfFalseExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RulePackage.CONDITIONAL__IF_FALSE_EXPRESSION, oldIfFalseExpression, newIfFalseExpression);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfFalseExpression(IntegerExpression newIfFalseExpression) {
		if (newIfFalseExpression != ifFalseExpression) {
			...
			if (ifFalseExpression != null)
				msgs = ((InternalEObject)ifFalseExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RulePackage.CONDITIONAL__IF_FALSE_EXPRESSION, null, msgs);
			if (newIfFalseExpression != null)
				msgs = ((InternalEObject)newIfFalseExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RulePackage.CONDITIONAL__IF_FALSE_EXPRESSION, null, msgs);
			msgs = basicSetIfFalseExpression(newIfFalseExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RulePackage.CONDITIONAL__IF_FALSE_EXPRESSION, newIfFalseExpression, newIfFalseExpression));
	}
	...
	public NotificationChain basicSetCondition(IntegerExpression newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RulePackage.CONDITIONAL__CONDITION, oldCondition, newCondition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCondition(IntegerExpression newCondition) {
		if (newCondition != condition) {
			NotificationChain msgs = null;
			if (condition != null)
				msgs = ((InternalEObject)condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RulePackage.CONDITIONAL__CONDITION, null, msgs);
			if (newCondition != null)
				msgs = ((InternalEObject)newCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RulePackage.CONDITIONAL__CONDITION, null, msgs);
			msgs = basicSetCondition(newCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RulePackage.CONDITIONAL__CONDITION, newCondition, newCondition));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RulePackage.CONDITIONAL__IF_TRUE_EXPRESSION:
				return basicSetIfTrueExpression(null, msgs);
			case RulePackage.CONDITIONAL__IF_FALSE_EXPRESSION:
				return basicSetIfFalseExpression(null, msgs);
			case RulePackage.CONDITIONAL__CONDITION:
