 ...
 * <ul>
 *   <li>{@link rule.impl.NeighborsExpressionImpl#getNeighborsFilter <em>Neighbors Filter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NeighborsExpressionImpl extends IntegerExpressionImpl implements NeighborsExpression {
	/**
	...
	protected EClass eStaticClass() {
		return RulePackage.Literals.NEIGHBORS_EXPRESSION;
	}
	...
	public NotificationChain basicSetNeighborsFilter(PopulationRange newNeighborsFilter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RulePackage.NEIGHBORS_EXPRESSION__NEIGHBORS_FILTER, oldNeighborsFilter, newNeighborsFilter);
	...
	public void setNeighborsFilter(PopulationRange newNeighborsFilter) {
		if (newNeighborsFilter != neighborsFilter) {
			...
			if (neighborsFilter != null)
				msgs = ((InternalEObject)neighborsFilter).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RulePackage.NEIGHBORS_EXPRESSION__NEIGHBORS_FILTER, null, msgs);
			if (newNeighborsFilter != null)
				msgs = ((InternalEObject)newNeighborsFilter).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RulePackage.NEIGHBORS_EXPRESSION__NEIGHBORS_FILTER, null, msgs);
			msgs = basicSetNeighborsFilter(newNeighborsFilter, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RulePackage.NEIGHBORS_EXPRESSION__NEIGHBORS_FILTER, newNeighborsFilter, newNeighborsFilter));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RulePackage.NEIGHBORS_EXPRESSION__NEIGHBORS_FILTER:
