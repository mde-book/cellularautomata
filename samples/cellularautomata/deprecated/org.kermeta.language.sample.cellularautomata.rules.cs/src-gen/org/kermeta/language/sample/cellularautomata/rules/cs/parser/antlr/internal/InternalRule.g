...
(
    ...
    { 
        $current = $this_NeighborsExpression_0.current; 
        afterParserOrEnumRuleCall();
    }
...
// Entry rule entryRuleNeighborsExpression
entryRuleNeighborsExpression returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getNeighborsExpressionRule()); }
	 iv_ruleNeighborsExpression=ruleNeighborsExpression 
	 { $current=$iv_ruleNeighborsExpression.current; } 
	 EOF 
;

// Rule NeighborsExpression
ruleNeighborsExpression returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((	otherlv_0='(' 
    ...
    { 
        $current = $this_IntegerLiteral_7.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_CurrentCellPopulation_8.current; 
        afterParserOrEnumRuleCall();
    }
)
;
