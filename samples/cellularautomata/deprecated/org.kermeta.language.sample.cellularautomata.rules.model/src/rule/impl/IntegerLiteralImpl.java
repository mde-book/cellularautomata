 ...
 * <ul>
 *   <li>{@link rule.impl.IntegerLiteralImpl#getVal <em>Val</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntegerLiteralImpl extends IntegerExpressionImpl implements IntegerLiteral {
	...
	protected EClass eStaticClass() {
		return RulePackage.Literals.INTEGER_LITERAL;
	}
	...
	public void setVal(int newVal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RulePackage.INTEGER_LITERAL__VAL, oldVal, val));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RulePackage.INTEGER_LITERAL__VAL:
				return getVal();
		}
